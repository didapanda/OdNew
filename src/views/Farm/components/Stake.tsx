...
import useMasterChefBalance from '../../../hooks/useMasterShifuBalance'
import useUnstake from '../../../hooks/useUnstake'
import { getBalanceNumber } from '../../../utils/formatBalance'
import DepositModal from './DepositModal'
import WithdrawModal from './WithdrawModal'
import panda from "../../../assets/img/panda.gif";
...
const Stake: React.FC<StakeProps> = ({ lpContract, pid, tokenName }) => {
  ...
  //const masterChefBalance = useMasterShifuBalance(lpContract.options.address)
    ...
    <Card>
      <CardContent>
        <StyledCardContentInner>
          <StyledCardHeader>
            {<img src={panda} height={64} width={64}/>} 
